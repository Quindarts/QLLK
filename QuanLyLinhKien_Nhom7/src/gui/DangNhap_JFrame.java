...
public class DangNhap_JFrame extends JFrame implements ActionListener {
	...
	private JCheckBox ckbMatKhau;
	private JSeparator separator;
	private JPanel panelLeft;
	private JLabel label;
	private JLabel lblLinhKin;
	...
	public DangNhap_JFrame() {
		...
		lblLinhKin = new JLabel("Linh Kiện Máy Tính");
		...
		ckbMatKhau = new JCheckBox(" Hiển thị mật khẩu");
